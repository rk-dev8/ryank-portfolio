  ...
  return (
    <>
      ...
      <div className="page-container">
        ...
        <h5>GeoMatch</h5>
        <p>GeoMatch is a bicycle geometry visualization tool designed to bridge the gap between different frame designs. By algorithmically comparing reach, stack, and angles, the app allows builders and sellers to match fit coordinates across disparate frames, ensuring a consistent ride feel regardless of the chassis. This project is currently in progress, and will hopefully be used in bike shops in the future. </p> <br />
        <p>built with React, MongoDB, Express, Node.js</p><br />

        <h5>Small Projects</h5>
        <p>In my github, you will see several projects from my Purdue Software Developement Program that were practice using:</p> <ul><li>React</li><li>JavaScript</li><li>Tailwind CSS</li><li>MySQL</li><li>MongoDB</li><li>Express</li><li>Node.js</li><li>Generative AI</li><li>Framework Testing</li></ul> 
      </div>
